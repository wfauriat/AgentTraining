# agent.py — LangGraph agent ported from lib_agent/ to the OpenAI-compatible
# endpoint. Topology, prune logic, HITL serial tool node, and tool list are
# unchanged; only the LLM constructors moved from ChatOllama to ChatOpenAI.
